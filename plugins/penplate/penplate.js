! function(a) {
    var b = function() {
        ...
        f.settings = {
            ...
            f.settings = a.extend(f.settings, d), b = c, $this_penplate_content = jQuery.trim(b.html()), $check_webplate = a(".webplate:first"), $check_webplate && $check_webplate.length > 0 && (l = !0), f.add_controls(), b.find("p:first").length < 1 && b.html("<p>" + $this_penplate_content + "</p>"), b.attr({
