        ...
        init: function (trumbowyg) {
          ...
          trumbowyg.addBtnDef('giphy', {
            fn: function() {
              ...
              var BASE_URL = 'https://api.giphy.com/v1/gifs/search?api_key=' + trumbowyg.o.plugins.giphy.apiKey + '&limit=' + trumbowyg.o.plugins.giphy.limit + '&rating=' + trumbowyg.o.plugins.giphy.rating,
