...
var allgooglefont = [];
if(localStorage['googlefonts']){
			var getgooglefonts =  JSON.parse(localStorage['googlefonts']);

let p = 0;
while (p < getgooglefonts.length) {
var fontfamily = getgooglefonts[p];
		fontfamily = fontfamily.replace(/\+/g,' ');
	    allgooglefont.push({name: fontfamily, family: fontfamily},);
 p++;
}	
}else{
}
...
var allfontList = [...allgooglefont, ...regularfontList];
    var defaultOptions = {
